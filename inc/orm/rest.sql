...
CREATE TABLE appoint (
  ...
  userx varchar(255) DEFAULT NULL,
  PRIMARY KEY (id)
);
...
CREATE TABLE mycut (
  ...
  status int DEFAULT NULL,
  getTime timestamp  DEFAULT NULL,
  useTime timestamp  DEFAULT NULL,
  PRIMARY KEY (id)
) ;
...
CREATE TABLE orderx (
  ...
  sumMoney int DEFAULT NULL,
  cupNumber int DEFAULT NULL,
  ...
  status int DEFAULT NULL,
  disTime timestamp  DEFAULT NULL,
  cutMonney int DEFAULT NULL,
...
CREATE TABLE userx (
  ...
  resum int DEFAULT NULL,
  province varchar(255) DEFAULT NULL,
  gender int DEFAULT NULL,
  city varchar(255) DEFAULT NULL,
  openId varchar(255) DEFAULT NULL,
  create_time timestamp  DEFAULT CURRENT_TIMESTAMP,
  last_loginTime timestamp  DEFAULT CURRENT_TIMESTAMP,
  phone varchar(255) DEFAULT NULL,
  PRIMARY KEY (id)
) ;
