...
namespace SMDB
{
    ...
    public:
        ...
        ROUTER_DB2(&CommonDBProcess::sgetSysAdmin, getSysAdminReq, AssDB::GetSysAdmin);
        ROUTER_DB2(&CommonDBProcess::sdelSysAdmin, delSysAdminReq, AssDB::DelSysAdmin);
        ROUTER_DB2(&CommonDBProcess::sgetUserGenInfo, getUserGenInfoReq, AssDB::GetUserGenInfo);
        END_ROUTER_MAP_DB;
    public:
